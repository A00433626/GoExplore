...
(function ($) {
    ...
    if (page === 'EventList') {
        //("body").addClass("events-list-page");
        document.getElementById("body").classList.add("events-list-page");
    }
    else if (page === 'News') {
        //("body").addClass("events-news-page");
        document.getElementById("body").classList.add("events-news-page");
    } else if (page === 'event_detail') {
        //("body").addClass("events-news-page");
        document.getElementById("body").classList.add("single-event-page");
    } 
    ...
    $(".increase-ticket").click(function() {
        ...
        var amt = $("#totalAmount").val() * $n.val();
        $(".ticket-price").html("$" + amt.toString());
        $("#totalAmount").val(amt);
    });
